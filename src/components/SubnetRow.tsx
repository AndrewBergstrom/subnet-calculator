  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Subnet Mask */}
        <div className="w-32 shrink-0 font-mono text-xs text-[var(--color-text-secondary)]">
          {subnetMaskString(prefix)}
        </div>

        {/* Usable Range */}
        <div className="w-64 shrink-0 font-mono text-xs text-[var(--color-text-secondary)]">
        ...
        {/* Broadcast */}
        <div className="w-28 shrink-0 font-mono text-xs text-[var(--color-text-muted)]">
          {intToIp(broadcast)}
        </div>
        ...
        {isLeaf && (
          <input
            ...
            placeholder="Label..."
            className="
              flex-1 min-w-[120px] px-2 py-1 rounded-lg text-xs
      ...
      {showColorPicker && isLeaf && (
        <div className="px-4 py-2 border-b border-[var(--color-border)] bg-[var(--color-surface-alt)] animate-fade-in"
